...
export const state: AppState = {
  ...
  store: { theme: 'light', locale: 'zh', homeBackgroundImage: '', homeBackgroundOpacity: 32, homeBackgroundBlur: 0, lastWorkspace: '', recentWorkspaces: [], pinnedSessions: [], sessionStatus: {} },
